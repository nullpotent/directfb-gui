...
enum INPUT_MODE {SMALLALPHA_MODE, BIGALPHA_MODE, NUM_MODE} INPUT_MODES;
...
Dialog* 		dialog_create(const char* name, DFBRectangle* dimensions, enum INPUT_MODE inputMode, DialogLooks* dlooks);
